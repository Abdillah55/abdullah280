...
description: "How the Nimro Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Nimro Desktop app connects to a **gated gateway** (a hosted or
...
For Nimro specifically, native sign-in means:
...
- [Run Nimro with Nous Portal](./run-nimro-with-nous-portal.md)
