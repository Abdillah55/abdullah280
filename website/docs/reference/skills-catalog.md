...
| [`nimro-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nimro-agent) | Use, configure, theme, extend, and orchestrate Nimro Agent. | `autonomous-ai-agents/nimro-agent` |
...
| [`nimro-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-nimro-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/nimro-agent-skill-authoring` |
| [`inspecting-nimro-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-nimro-desktop-dom) | Read the live Nimro desktop DOM/CSS over CDP. | `software-development/inspecting-nimro-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .nimro/plans/; no execution. | `software-development/plan` |
