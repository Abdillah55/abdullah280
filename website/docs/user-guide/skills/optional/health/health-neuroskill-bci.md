...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/health/neuroskill-bci` |
...
Connect Nimro to a running [NeuroSkill](https://neuroskill.com/) instance to read
