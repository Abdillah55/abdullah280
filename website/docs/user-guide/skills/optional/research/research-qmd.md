...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`nimro-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nimro-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Nimro Agent via the native MCP client. This is the preferred
...
Then configure Nimro Agent to connect via HTTP:
