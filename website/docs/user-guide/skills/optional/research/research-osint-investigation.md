...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Nimro Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $NIMRO_OSINT_CACHE/icij/ (default: ~/.cache/nimro-osint/icij/).
...
# Set NIMRO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
