...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/research/gitnexus-explorer` |
...
| Related skills | [`nimro-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nimro-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
