...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Nimro Agent (adapted from obra/superpowers) |
| License | MIT |
