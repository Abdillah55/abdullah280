...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing nimro tool access (web_search, file ops). Stateless. |
