...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Nimro Agent |
| License | MIT |
...
The script reads `${NIMRO_HOME:-~/.nimro}/.env` for two optional defaults:
...
Helper script: `~/.nimro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.nimro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${NIMRO_HOME:-~/.nimro}/.env`.
...
```bash
python3 ~/.nimro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.nimro/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
