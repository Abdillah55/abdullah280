...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/web-development/page-agent` |
...
- User wants **Nimro itself to drive a browser** → use Nimro' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
