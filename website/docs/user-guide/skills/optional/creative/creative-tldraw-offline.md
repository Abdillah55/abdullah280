...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative/tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + Nimro Agent |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This Nimro skill mirrors that guidance for Nimro.)
