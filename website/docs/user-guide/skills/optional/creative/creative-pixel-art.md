...
| | |
|---|---|
| Source | Optional — install with `nimro skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.nimro/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.nimro/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Nimro installs package this)
