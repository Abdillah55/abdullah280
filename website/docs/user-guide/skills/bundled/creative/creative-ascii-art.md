...
```bash
python3 -m pyfiglet "NIMRO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=NIMRO&font=Slant" | boxes -d stone
```
