#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Nimro docs site.
...
Both publish at:
  https://nimro-agent.nousresearch.com/docs/llms.txt
  https://nimro-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://nimro-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Nimro as a Python Library", None),
        ("guides/use-mcp-with-nimro", "Use MCP with Nimro", None),
        ("guides/use-voice-mode-with-nimro", "Use Voice Mode with Nimro", None),
        ("guides/use-soul-with-nimro", "Use SOUL.md with Nimro", None),
        ("guides/build-a-nimro-plugin", "Build a Nimro Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Nimro"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "nimro-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/nimro-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Nimro Agent — Full Documentation\n",
        (
            "This file is the entire Nimro Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Nimro, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://nimro-agent.nousresearch.com/docs\n",
        "Short index: https://nimro-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
