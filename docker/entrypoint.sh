...
# by /etc/cont-init.d/01-nimro-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs nimro"
...
echo "[nimro] WARNING: docker/entrypoint.sh is a deprecated shim under " \
