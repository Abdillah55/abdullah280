...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$NIMRO_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_nimro_dir("platforms/whatsapp/session", "whatsapp/session")
