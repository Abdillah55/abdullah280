...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Nimro session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Nimro session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Nimro agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Nimro Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Nimro gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Nimro session in it",
