...
Hooks are discovered from ~/.nimro/hooks/ directories, each containing:
...
HOOKS_DIR = get_nimro_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"nimro_hook_{hook_name}"
