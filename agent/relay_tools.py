"""Core NeMo Relay adapter for Nimro tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Nimro tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Nimro Relay tool execution cannot run on an active event-loop thread"
    )
