...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``nimro logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Nimro only initiates compaction in "nimro" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Nimro preflight compression for codex app-server "
                "(mode=%s); Nimro will not start thread compaction here.",
