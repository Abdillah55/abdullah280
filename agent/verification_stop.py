...
def verify_on_stop_enabled(config: dict[str, Any] | None = None) -> bool:
    ...
    Precedence: an explicit ``NIMRO_VERIFY_ON_STOP`` env var wins, then an
    ...
    """
    env = os.environ.get("NIMRO_VERIFY_ON_STOP")
    if env is not None:
    ...
    *,
    ...
    if verify_commands:
        ...
        command_instruction = (
            ...
            "`tempfile` path with a `nimro-verify-` filename prefix, run it "
