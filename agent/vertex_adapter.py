"""Vertex AI (Google Cloud) adapter for Nimro Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Nimro to use Gemini models via Google Cloud with
...
# who installed plain `nimro-agent` and only later selected a Gemini model.
try:
