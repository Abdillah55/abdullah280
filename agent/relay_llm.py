"""Core NeMo Relay adapters for physical Nimro provider attempts."""
...
def execute_current(
    ...
    *,
    ...
    """Run a provider attempt under the inherited Nimro turn when present."""
...
def stream_current(
    ...
    *,
    ...
    """Run a provider stream under the inherited Nimro turn when present.
...
class ManagedLlmStream(Iterator[Any]):
    """Drive Relay's async stream from Nimro's provider worker thread."""
...
class AnthropicStreamAccumulator:
    ...
    def response(self, base: Any = None) -> Any:
        """Return the attribute-shaped response consumed by Nimro."""
