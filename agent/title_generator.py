...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from agent code paths where a module-level nimro_cli import risks
...
def auto_title_session(
    ...
    post-``nimro update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Nimro process): %s",
            e,
        )
