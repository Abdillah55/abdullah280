...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Nimro's web-provider config and
        ...
        # native search engine for xAI sessions instead of Nimro's
        # configured web provider (Tavily/etc.), and those results bypass
        # Nimro's tool-trace / citation plumbing (they arrive baked into the
