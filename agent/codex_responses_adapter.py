...
def _clamp_responses_call_id(call_id: str) -> str:
    ...
    component the built-in ``nimro-tools`` server already overflows 64 chars,
...
# output items.  Nimro injects xAI's native ``web_search`` for the xAI
...
# server-assigned base64 blobs that can run 400+ chars, while Nimro-minted
...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on Nimro threading encrypted reasoning back across
                ...
                if isinstance(codex_reasoning, list):
                    for ri in codex_reasoning:
                        if isinstance(ri, dict) and ri.get("encrypted_content"):
                            ...
                            # it is a Nimro-side metadata key and not part
...
def _normalize_codex_response(
    ...
    *,
    ...
    if tool_calls:
        ...
        # See https://github.com/NousResearch/nimro-agent/issues/64434
