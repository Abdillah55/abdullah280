...
decomposition campaign (``~/.nimro/plans/god-file-decomposition.md``, Phase 1
...
def finalize_turn(
    ...
    *,
    ...
    if iteration_limit_fallback:
        ...
        _kanban_task = os.environ.get("NIMRO_KANBAN_TASK")
        if _kanban_task:
            try:
    ...
    result = {
        ...
        # billing audits by callers like `nimro -z --usage-file`.
        "service_tier": (
