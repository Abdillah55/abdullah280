# Streaming LLM Response Support for Nimro Agent
...
```
NIMRO_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("NIMRO_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `nimro_cli/config.py` | 1 | +streaming config defaults |
