      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via NIMRO_BUNDLED_SKILLS /
            # NIMRO_OPTIONAL_SKILLS (see nimro-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + NIMRO_BUNDLED_LOCALES
            # / NIMRO_OPTIONAL_MCPS, not via the wheel. Excluding them
