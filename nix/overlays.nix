# nix/overlays.nix — Expose pkgs.nimro-agent for external NixOS configs
#
...
# `pkgs.nimro-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    nimro-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
