...
const STORAGE_KEY = "nimro-dashboard-theme";
...
const FONT_STORAGE_KEY = "nimro-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `nimro_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "nimro-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-nimro-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-nimro-theme-font", "true");
