 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `nimro_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Nimro Teal",
  description: "Classic dark teal — the canonical Nimro look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Nimro Teal (Large)",
  description: "Nimro Teal with bigger fonts and roomier spacing",
