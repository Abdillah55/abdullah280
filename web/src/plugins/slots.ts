 ...
 * `window.__NIMRO_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Nimro brand in the top bar
 ...
 *  `window.__NIMRO_PLUGINS__.registerSlot(...)`.
 *
