 ...
 *
 * Plugins call window.__NIMRO_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__NIMRO_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__NIMRO_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__NIMRO_PLUGIN_SDK__ = {
    ...
    // window.__NIMRO_SESSION_TOKEN__ directly.
    authedFetch,
