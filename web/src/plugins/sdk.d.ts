/**
 * Nimro Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__NIMRO_PLUGIN_SDK__`` and
 * ``window.__NIMRO_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__NIMRO_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``NimroPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@nimro/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__NIMRO_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__NIMRO_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__NIMRO_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface NimroPluginSDK {
...
declare global {
  interface Window {
    __NIMRO_PLUGIN_SDK__?: NimroPluginSDK;
    __NIMRO_PLUGINS__?: PluginRegistry;
  }
}
