 ...
 *
 * Values mirror nimro_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Nimro default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Nimro' default when unset). */
