/**
 * Canonical Nimro skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$NIMRO_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`nimro_cli/skin_engine.py`),
 ...
 *   • CLI     → `nimro_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
