/**
 * @nimro/plugin-sdk — THE plugin language. The vscode-module model: plugin
 ...
 *    object as `window.__NIMRO_PLUGIN_SDK__` and maps the import to it, so a
...
import { getLogs, getStatus } from '@/nimro'
...
/** Nimro' reasoning levels + their compact labels, so a plugin surfacing a
...
export type { RpcEvent, StatusResponse } from '@/types/nimro'
