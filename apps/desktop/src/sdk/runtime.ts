 ...
 * plugins resolve `@nimro/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __NIMRO_PLUGIN_SDK__: sdk,
  __NIMRO_REACT__: React,
  __NIMRO_REACT_JSX__: jsxRuntime,
  __NIMRO_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@nimro/plugin-sdk': shimUrl('__NIMRO_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__NIMRO_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__NIMRO_REACT_JSX__'),
    react: shimUrl('__NIMRO_REACT__')
  }
