 ...
 * `<nimro home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'nimro.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'nimro.desktop.disabledPlugins.v1'
