...
import { type BillingBlock, skillInvocationText } from '@nimro/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/nimro'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @nimro/shared BillingBlock).
