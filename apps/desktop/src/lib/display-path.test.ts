...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/nimro-agent')).toBe('~/www/nimro-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/nimro-agent')).toBe('nimro-agent')
    expect(pathLeaf('~/www/nimro-agent')).toBe('nimro-agent')
