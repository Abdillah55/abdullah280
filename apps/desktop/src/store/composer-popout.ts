...
const POPOUT_STORAGE_KEY = 'nimro.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'nimro.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'nimro.desktop.composerPopout.position'
