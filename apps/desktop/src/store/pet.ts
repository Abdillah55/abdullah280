...
export interface PetInfo {
  ...
  // the Nimro "run" activity state uses the in-place running row).
 ...
 * NIMRO_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'nimro.desktop.pet-roam.v1'
