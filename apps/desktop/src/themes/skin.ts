/**
 * Nimro skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$NIMRO_HOME/skins/` (or a
 * built-in) resolved by `nimro_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Nimro authors from a prompt lights up all three surfaces from one file.
 *
...
import type { NimroSkin, SkinColors } from '@nimro/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: NimroSkin): DesktopTheme | null {
