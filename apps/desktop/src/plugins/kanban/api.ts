...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@nimro/plugin-sdk'
...
/** First-class Nimro projects, for scoping a board's default workspace. */
