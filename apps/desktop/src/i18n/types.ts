...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshNimroPathTitle: string
      sshNimroPathDesc: string
      sshNimroPathPlaceholder: string
  ...
  commandCenter: {
    ...
    nimroActiveSessions: (version: string, count: number) => string
