...
export const en: Translations = {
  ...
  boot: {
    ready: 'Nimro Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Nimro settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingNimroDesktop: 'Starting Nimro Desktop…'
    },
    errors: {
      backgroundExited: 'Nimro background process exited.',
      backgroundExitedDuringStartup: 'Nimro background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Nimro backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateNimro: 'Update Nimro',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Nimro Desktop.',
    ...
    native: {
      ...
      inputBody: 'Nimro is waiting for your response.',
      turnDoneTitle: 'Nimro finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Nimro defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Nimro is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Nimro asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Nimro was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Nimro follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Nimro can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Nimro is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Nimro, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Nimro checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Nimro configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Nimro.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Nimro backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc:
        'Unset NIMRO_DESKTOP_REMOTE_URL and NIMRO_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Nimro backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Nimro backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Nimro Cloud',
      cloudDesc: 'Sign in once to Nimro Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Nimro Cloud',
      cloudSignIn: 'Sign in to Nimro Cloud',
      cloudSignedIn: 'Signed in to Nimro Cloud',
      cloudNeedsSignIn: 'Sign in to Nimro Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Nimro Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Nimro Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Nimro Cloud',
      cloudSignedOutMessage: 'Cleared the Nimro Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /nimro.',
      ...
      restartingMessage: 'Nimro Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Nimro ${version}` : ''}`,
      ...
      sshDesc:
        'Nimro is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshNimroPathTitle: 'Nimro path (optional)',
      sshNimroPathDesc: 'Full path to the remote nimro binary. Blank = auto-detect.',
      sshNimroPathPlaceholder: 'auto-detect',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Nimro found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Nimro runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Nimro is not installed on the remote host. Install it there (curl -fsSL https://nimro-agent.nousresearch.com/install.sh | sh) or set the Nimro path.',
      sshErrPlatform:
        'Unsupported remote platform. Nimro Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Nimro on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Nimro runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Nimro at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via nimro curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Nimro builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Nimro to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Nimro to generate pets.',
      backgroundHint: 'You can close this — Nimro will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Nimro desktop' },
    ...
    nimroActiveSessions: (version, count) => `Nimro ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@nimro:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Nimro environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Nimro will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Nimro backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Nimro. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Nimro...',
    placeholderReconnecting: 'Reconnecting to Nimro…',
    ...
    attachUrlDesc: 'Nimro will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Nimro to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Nimro…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Nimro…',
    ...
    unsupportedMessage: 'This version of Nimro can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Nimro from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Nimro will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Nimro desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Nimro updater takes over in its own window and reopens Nimro automatically when it’s done. Please don’t reopen Nimro yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Nimro reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Nimro reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Nimro needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Nimro Desktop',
    setupChoiceDesc:
      'Connect this app to a Nimro gateway you already run, or install Nimro locally on this computer.',
    connectExistingTitle: 'Connect to existing Nimro',
    ...
    installLocalTitle: 'Install Nimro locally',
    installLocalDesc: 'Download Nimro, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Nimro Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Nimro',
    remoteSetupDesc: 'Enter your gateway URL. Nimro Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Nimro gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/nimro',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Nimro gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Nimro Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Nimro CLI or desktop instance is running. Stop any running Nimro instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Nimro Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Nimro is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Nimro…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Nimro',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Nimro at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Nimro connects automatically',
    ...
    authorizeThere: 'Authorize Nimro there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Nimro there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Nimro Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Nimro Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Nimro will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Nimro is restarting...',
      askRestart: 'Ask Nimro to restart the server',
      lookingRestart: taskId => `Nimro is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Nimro is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Nimro finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Nimro could not restart the server.',
      stillWorking:
        'Nimro is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Nimro is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Nimro gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.nimro/config.yaml). Nimro won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Nimro needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Nimro needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Nimro Desktop to use Save Image.',
    restartToSaveImages: 'Restart Nimro Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `nimro gateway` running?'
    }
  },
