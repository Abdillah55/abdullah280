...
import { getNimroConfigRecord, listAllProfileSessions } from '@/nimro'
...
// Nimro session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-nimro',
            keywords: ['update', 'upgrade', 'nimro', 'version', 'system', 'restart'],
            label: cc.updateNimro,
