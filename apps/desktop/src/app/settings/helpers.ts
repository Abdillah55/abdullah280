...
import type { ConfigFieldSchema, NimroConfigRecord, ToolsetInfo } from '@/types/nimro'
...
export function getNested(obj: NimroConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: NimroConfigRecord, path: string, value: unknown): NimroConfigRecord {
...
function personalityOptions(config: NimroConfigRecord): string[] {
...
function commandProviderNames(config: NimroConfigRecord, section: 'tts' | 'stt'): string[] {
