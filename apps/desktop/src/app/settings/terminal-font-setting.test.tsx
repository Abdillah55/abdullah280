...
vi.mock('@/nimro', () => ({
  saveNimroConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setNimroConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useNimroConfigRecord: () => ({ data: mocks.loadedConfig })
}))
