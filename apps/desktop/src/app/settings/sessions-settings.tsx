...
import type { NimroConfigRecord, SessionInfo } from '@/types/nimro'
...
// / Program Files), which buried any files Nimro wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.nimroDesktop` is
    ...
    const settings = window.nimroDesktop?.settings
