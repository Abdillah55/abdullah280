...
import { saveNimroConfig } from '@/nimro'
...
function fontFamilyFromConfig(config: NimroConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useNimroConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<NimroConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setNimroConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="nimro-terminal-font-families"
          ...
          <datalist id="nimro-terminal-font-families">
