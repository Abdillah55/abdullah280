...
describe('GatewaySettings', () => {
  it('labels local mode as default inheritance for a named profile', async () => {
    ...
    expect(
      screen.getByText('Start a private Nimro backend on localhost. This is the default and works offline.')
    ).toBeTruthy()
    ...
    expect(
      screen.queryByText('Start a private Nimro backend on localhost. This is the default and works offline.')
    ).toBeNull()
  })
    ...
    getConnectionConfig.mockImplementation(async profile =>
      profile === 'work'
        ? {
            ...
            sshPort: 22,
            sshKeyPath: '',
            sshRemoteNimroPath: '/opt/nimro/bin/nimro',
