...
import { type DroppedFile, extractDroppedFiles, NIMRO_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, NIMRO_PATHS_MIME) ? 'files' : null
