...
const FOCUS_EVENT = 'nimro:composer-focus'
const INSERT_EVENT = 'nimro:composer-insert'
const INSERT_REFS_EVENT = 'nimro:composer-insert-refs'
const SUBMIT_EVENT = 'nimro:composer-submit'
const VOICE_TOGGLE_EVENT = 'nimro:composer-voice-toggle'
const MODEL_MENU_EVENT = 'nimro:composer-model-menu'
