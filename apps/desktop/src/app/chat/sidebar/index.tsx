...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/nimro'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('nimro:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('nimro:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Nimro to
