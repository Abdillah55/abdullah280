...
import type { ProjectInfo, SessionInfo } from '@/nimro'
 ...
 * repo shows its branches/worktrees even when they have no Nimro sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: NimroGitWorktree[]
): SidebarSessionGroup[] {
