...
const TAKEOVER_KEY = 'nimro.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Nimro can't clear via the API — the user
 *  sees exactly what runs instead of Nimro silently deleting their creds. */
