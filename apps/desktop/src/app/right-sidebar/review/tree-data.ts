import type { NimroReviewFile } from '@/global'
...
export function buildReviewFlatList(files: NimroReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: NimroReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
