...
// by main.ts (`setBackgroundThrottling` driven by the merged `nimro:active-work`
...
// (the "Nimro idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Nimro" wake word has NO preceding click,
