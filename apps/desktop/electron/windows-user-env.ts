...
// even though a fresh shell — and the Nimro CLI — sees it immediately. The
// desktop's NIMRO_HOME resolution relies on process.env, so that stale-snapshot
...
//       NIMRO_HOME    REG_SZ    F:\Nimro\data
//
