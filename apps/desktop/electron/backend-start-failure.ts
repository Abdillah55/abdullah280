 ...
 * startNimro() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startNimro() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startNimro`, re-emits
