...
/**
 * E2E smoke tests for the packaged Nimro desktop app.
 *
 ...
 * (credential stripping, isolated NIMRO_HOME + userData, unique app name).
 *
...
test('window opens with the Nimro title', async () => {
