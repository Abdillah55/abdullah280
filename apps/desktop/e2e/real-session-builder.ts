 ...
 * AIAgent loop, using the E2E mock provider configured in `nimroHome`.
 *
...
export class RealSessionBuilder {
  ...
  static async start(nimroHome: string): Promise<RealSessionBuilder> {
    const builder = new RealSessionBuilder(nimroHome)
