...
export default defineConfig(({ command }) => ({
  ...
  resolve: {
    alias: {
      ...
      '@nimro/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@nimro/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@nimro/shared': path.resolve(__dirname, '../shared/src'),
