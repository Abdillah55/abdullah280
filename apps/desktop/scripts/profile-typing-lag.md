...
cd apps/desktop
XCURSOR_SIZE=24 NIMRO_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/nimro-typing
# → /tmp/nimro-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/nimro-typing.before.heapsnapshot
# → /tmp/nimro-typing.after.heapsnapshot
```
