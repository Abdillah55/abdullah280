...
Data file: $NIMRO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NIMRO_HOME = Path(os.environ.get("NIMRO_HOME", Path.home() / ".nimro"))
DATA_DIR = _NIMRO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
