...
def _state_dir() -> Path:
    ...
    # Default: $NIMRO_HOME/watcher-state/, falling back to ~/.nimro/watcher-state/.
    nimro_home = os.environ.get("NIMRO_HOME") or str(Path.home() / ".nimro")
    return Path(nimro_home) / "watcher-state"
