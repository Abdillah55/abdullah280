...
Config: ~/.nimro/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.nimro/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_nimro_home()`` helper (NIMRO_HOME-aware and
...
RULES_FILE = get_nimro_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_nimro_home() / "feishu_comment_pairing.json"
