"""
A2A (Agent-to-Agent) plugin for Nimro Agent.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Nimro as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`nimro gateway setup` flow for A2A."""
    ...
    print_info("Expose Nimro as an A2A-discoverable agent and call other A2A agents.")
