...
required — uses aiohttp which is already a Nimro dependency.
...
def interactive_setup() -> None:
    ...
    ``nimro_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Nimro delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # nimro_cli/setup.py::_setup_mattermost function.
