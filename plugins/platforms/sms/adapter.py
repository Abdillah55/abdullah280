...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Nimro gateway adapter.

    Each inbound phone number gets its own Nimro session (multi-tenant).
...
# static dict in nimro_cli/gateway.py, and the _send_sms dispatch in
