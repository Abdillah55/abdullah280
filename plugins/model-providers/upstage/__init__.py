...
# When the user hasn't picked a reasoning effort, Nimro passes
...
# ON at this effort — matching the "medium (default)" that Nimro' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Nimro' effort vocabulary onto Solar's accepted set. xhigh/max/
