...
Configuration
-------------
Secret (lives in $NIMRO_HOME/.env or the environment):
...
Behavioral settings (live in $NIMRO_HOME/mem0.json, set via `nimro memory
setup`):
  ...
  agent_id           — Agent identifier (default: nimro)
...
def _load_config() -> dict:
    """Load config from env vars, with $NIMRO_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "nimro"),
        "oss": {},
    }
    ...
    config_path = get_nimro_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, nimro_home):
        """Write config to $NIMRO_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $NIMRO_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "nimro")
