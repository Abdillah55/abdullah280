# Nimro Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.nimro/plugins/nimro-achievements/state.json` (existing unlock state)
  - `~/.nimro/plugins/nimro-achievements/scan_snapshot.json` (new)
  - `~/.nimro/plugins/nimro-achievements/scan_checkpoint.json` (new)
