# Nimro Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.nimro/plugins/nimro-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.nimro/plugins/nimro-achievements/scan_checkpoint.json`.
