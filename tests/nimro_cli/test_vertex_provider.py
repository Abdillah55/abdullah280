...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (nimro_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_nimro_overlays():
    """nimro_cli.providers.get_provider("vertex") backs
