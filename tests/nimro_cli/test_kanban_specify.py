"""Tests for the specifier module + `nimro kanban specify` CLI surface.
...
from nimro_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `nimro kanban …` argparse surface directly."""
