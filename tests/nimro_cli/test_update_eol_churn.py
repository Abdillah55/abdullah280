"""Regression: ``nimro update`` should take a managed checkout off autocrlf=true.
...
``nimro update`` has to repair them.
...
from nimro_cli.update_cmd import _normalize_managed_eol
