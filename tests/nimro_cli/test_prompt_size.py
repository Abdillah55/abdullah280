"""Tests for the ``nimro prompt-size`` diagnostic (issue #34667)."""
...
from nimro_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(nimro_home, memory_text="", user_text=""):
    mem_dir = nimro_home / "memories"
...
def _seed_skill(nimro_home, name, description):
    skill_dir = nimro_home / "skills" / "demo" / name
