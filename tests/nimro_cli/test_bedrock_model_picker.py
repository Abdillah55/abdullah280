...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (NIMRO_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via NIMRO_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in NIMRO_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from nimro_cli.providers import NIMRO_OVERLAYS
        assert "bedrock" in NIMRO_OVERLAYS
