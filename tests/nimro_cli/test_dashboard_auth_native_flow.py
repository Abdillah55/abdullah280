...
Run: pytest tests/nimro_cli/test_dashboard_auth_native_flow.py
"""
...
from nimro_cli.dashboard_auth.base import Session
...
def _walk_native_login(client, *, redirect_uri, challenge, state="cli-state"):
    ...
    assert "nimro_session_at" not in set_cookie, (
