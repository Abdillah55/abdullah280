...
def _clear_cache():
    ...
    import nimro_cli.models as mod
...
class TestGetCopilotModelContext:
    ...
    @patch("nimro_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("nimro_cli.models._urlopen_model_catalog_request")
    ...
    @patch("nimro_cli.models.fetch_github_model_catalog", return_value=[])
