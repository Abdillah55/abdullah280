"""Tests for `nimro secrets bitwarden token` / `nimro secrets onepassword token`.
...
from nimro_cli import onepassword_secrets_cli as op_cli
from nimro_cli import secrets_cli as bw_cli
