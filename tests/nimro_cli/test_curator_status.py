"""Tests for `nimro curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated NIMRO_HOME with real agent-created skills on disk."""
    home = tmp_path / ".nimro"
    skills = home / "skills"
    ...
    from nimro_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import nimro_cli.curator as curator_cli
