"""Tests for ``nimro approvals suggest`` (nimro_cli/approvals_suggest.py).

Approval history in Nimro is implied, not ledgered: the session DB
...
from nimro_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
