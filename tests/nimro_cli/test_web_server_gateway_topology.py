...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_nimro_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # Nimro Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside nimro_home / gateway_pid.
            assert "gateways" not in data
            assert "nimro_home" not in data
