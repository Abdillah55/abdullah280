...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`nimro_cli.slash_exec.EXECUTORS`, and
...
from nimro_cli.commands import COMMAND_REGISTRY, resolve_command
from nimro_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
