"""Behavior tests for nimro_cli.inventory.
...
def test_build_models_payload_forwards_refresh_flag():
    ...
    with patch("nimro_cli.model_switch.list_authenticated_providers", side_effect=_capture):
...
def test_list_authenticated_providers_refresh_busts_cache():
    ...
    from nimro_cli import model_switch

    with patch("nimro_cli.models.clear_provider_models_cache") as clear:
