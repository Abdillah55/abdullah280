"""Tests for the interactive session browser (`nimro sessions browse`).
...
from nimro_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """nimro sessions browse should be parseable."""
