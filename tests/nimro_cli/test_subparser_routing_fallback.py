...
The main() function in nimro_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `nimro -c model`
...
def _build_parser():
    """Build a minimal replica of the nimro top-level parser."""
