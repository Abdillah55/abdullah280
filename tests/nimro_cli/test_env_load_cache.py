...
The cache exists to keep `nimro tools` → "All Platforms" fast: every
...
def test_remove_env_value_invalidates_cache(tmp_path, monkeypatch):
    ...
    from nimro_cli import config as config_mod
    ...
    monkeypatch.setattr(config_mod, "ensure_nimro_home", lambda: None)
