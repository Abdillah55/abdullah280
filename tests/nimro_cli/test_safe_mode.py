"""Tests for `nimro chat --safe-mode` isolation."""
...
_VARS = ("NIMRO_SAFE_MODE", "NIMRO_IGNORE_USER_CONFIG", "NIMRO_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["NIMRO_SAFE_MODE"] == "1"
        assert os.environ["NIMRO_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["NIMRO_IGNORE_RULES"] == "1"
        return True
