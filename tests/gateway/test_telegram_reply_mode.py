...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/NousResearch/nimro-agent/issues/23994:
    reply_to_mode 'off' was ignored when sending via Nimro-created DM topic
