...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("NIMRO_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("NIMRO_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("NIMRO_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
