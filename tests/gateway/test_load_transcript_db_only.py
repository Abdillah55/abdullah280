...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.nimro/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at nimro_state import time, before pytest's NIMRO_HOME monkeypatch
    fires — the autouse fixture's NIMRO_HOME override doesn't help here.)
    """
    import nimro_state
