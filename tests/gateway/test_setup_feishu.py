"""Tests for _setup_feishu() in nimro_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("nimro_cli.config.save_env_value", side_effect=mock_save), \
         patch("nimro_cli.config.get_env_value", side_effect=mock_get), \
         patch("nimro_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("nimro_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("nimro_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("nimro_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("nimro_cli.cli_output.print_header"), \
         patch("nimro_cli.cli_output.print_info"), \
         patch("nimro_cli.cli_output.print_success"), \
         patch("nimro_cli.cli_output.print_warning"), \
         patch("nimro_cli.cli_output.print_error"), \
