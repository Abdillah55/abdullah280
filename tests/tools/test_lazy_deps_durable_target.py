...
class TestGatingWithTarget:
    """``NIMRO_DISABLE_LAZY_INSTALLS=1`` must STOP blocking once a durable
...
@pytest.mark.skipif(
    os.environ.get("NIMRO_RUN_NETWORK_TESTS") != "1",
    reason="opt-in real-install test (set NIMRO_RUN_NETWORK_TESTS=1); CI runs "
