...
def worker_loop(worker_id: int, nimro_home: str, result_file: str) -> None:
...
def reclaimer_loop(nimro_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="nimro_mixed_stress_")
    print(f"NIMRO_HOME = {home}")
