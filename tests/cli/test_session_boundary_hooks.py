...
from nimro_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/nimro_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("nimro_cli.lifecycle.invoke_hook")
@patch("nimro_cli.lifecycle.finalize_session")
