"""Session <-> workspace grouping key (nimro_state.workspace_key).

The key is what `nimro sessions list --workspace` groups/filters on. It is a
...
from nimro_state import workspace_key
