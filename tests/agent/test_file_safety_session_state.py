...
manipulation. Nimro keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point NIMRO_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_nimro_home /
    get_default_nimro_root) instead of monkeypatching private helpers —
    ...
    NIMRO_HOME=<root>/profiles/<name> makes get_default_nimro_root()
