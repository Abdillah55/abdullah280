...
The unit tests in tests/nimro_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned nimro-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/nimro")
from nimro_cli.service_manager import S6ServiceManager
