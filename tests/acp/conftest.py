...
Keeps the ACP server tests offline: ``NimroACPAgent._build_model_state``
calls ``nimro_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import nimro_cli.inventory as inventory
