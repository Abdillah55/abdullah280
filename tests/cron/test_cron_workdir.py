...
class TestRunJobTerminalCwd:
    ...
    def _install_stubs(monkeypatch, observed: dict):
        ...
        # Bypass the real provider resolver — it reads ~/.nimro and credentials.
        from nimro_cli import runtime_provider as _rtp
        monkeypatch.setattr(
            _rtp,
        ...
        monkeypatch.setenv("NIMRO_CRON_TIMEOUT", "0")

        # run_job calls load_dotenv(~/.nimro/.env, override=True), which will
