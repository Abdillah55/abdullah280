...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("nimro_cli.config.get_config_path", return_value=config_path), \
             patch("nimro_cli.config.ensure_nimro_home"):
    ...
    def test_ensure_nimro_home_sets_0700(self):
        home = Path(self.tmpdir) / ".nimro"
