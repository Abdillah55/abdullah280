...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and nimro-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # nimro-agent (tests/skills/)
]
