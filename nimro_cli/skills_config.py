"""
Skills configuration for Nimro Agent.
`nimro skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.nimro/config.yaml under:
...
from nimro_cli.config import cfg_get, load_config, save_config
from nimro_cli.colors import Colors, color
from nimro_cli.platforms import PLATFORMS as _PLATFORMS
