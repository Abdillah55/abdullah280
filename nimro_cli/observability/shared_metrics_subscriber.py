"""Relay subscriber for the persisted Nimro shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Nimro counters from Relay lifecycle events."""
    ...
    def __init__(
        ...
        *,
        ...
        self.store = store
        self._nimro_version = nimro_version or "unknown"
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Nimro shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
