"""
Nimro CLI - Unified command-line interface for Nimro Agent.

Provides subcommands for:
- nimro chat          - Interactive chat (same as ./nimro)
- nimro gateway       - Run gateway in foreground
- nimro gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `nimro setup` on a fresh Pi.
    ...
    nimro_cli/stdio.py::configure_windows_stdio() runs later from the entry
