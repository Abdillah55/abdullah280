...
Invoked by ``nimro kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Nimro Agent board.
...
def _profile_author() -> str:
    """Mirror of ``nimro_cli.kanban._profile_author``."""
    return (
