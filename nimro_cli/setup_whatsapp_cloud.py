...
Entry point: ``nimro whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``nimro_cli/main.py``).
...
Nimro gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Nimro to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Nimro needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Nimro gateway in another terminal:")
    print("         nimro gateway")
    print()
    ...
    print()
    print("  Docs: https://nimro-agent.nousresearch.com/docs/user-guide/")
