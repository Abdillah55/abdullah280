"""Client for uploading ``nimro debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``nimro debug share``.
...
NAS_BASE = os.environ.get(
    "NIMRO_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "nimro-agent/debug-share"
