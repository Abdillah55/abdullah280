#!/usr/bin/env python3
"""
SWE Runner with Nimro Trajectory Format

A runner that uses Nimro-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Nimro-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Nimro-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Nimro format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Nimro-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Nimro-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Nimro Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Nimro-Agent's built-in execution environments
    and outputs trajectories in Nimro-Agent format.
    """
    ...
    def _convert_to_nimro_format(
        ...
        """
        Convert internal message format to Nimro trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Nimro trajectory format
        trajectory = self._convert_to_nimro_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Nimro trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Nimro Trajectory Format")
    print("=" * 60)
