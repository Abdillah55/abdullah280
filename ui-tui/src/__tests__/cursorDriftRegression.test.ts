 ...
 *
 * Symptom: in `nimro --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@nimro/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using nimro --tui and as i type multiline my caret at the end will often ' +
