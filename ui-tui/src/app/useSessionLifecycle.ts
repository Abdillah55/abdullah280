...
import type { ScrollBoxHandle } from '@nimro/ink'
import { evictInkCaches } from '@nimro/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.NIMRO_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
