...
import { Box, type ScrollBoxHandle, stringWidth, Text } from '@nimro/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (NIMRO_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (NIMRO_DEV_CREDITS), lowest priority,
