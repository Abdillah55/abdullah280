 ...
 * across theme x background scenes to <tmpdir>/nimro-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@nimro/ink'
...
// The regenerated slate light_colors block from nimro_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/nimro-agent',
...
const setup = (bgHex: string) => {
  process.env.NIMRO_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
