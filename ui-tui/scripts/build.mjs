...
await build({
  ...
  // Skip the prebuilt @nimro/ink bundle and inline the source instead:
  ...
  alias: { '@nimro/ink': resolve(root, 'packages/nimro-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The nimro_cli launcher
