...
Only included in the nimro-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Nimro-Agent (https://github.com/NousResearch/nimro-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_nimro_home() / "cache" / "discord_capabilities.json"
