...
the get_anchored_view / get_messages_around primitives in nimro_state.
...
# Third-party integrations tag their sessions with NIMRO_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from nimro_state import _default_db_path
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Nimro conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. Nimro renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Nimro conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Nimro profile's database "
