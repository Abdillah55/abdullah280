...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of NousResearch/nimro-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of NousResearch/nimro-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (NousResearch/nimro-agent#67052). ``ok`` stays
