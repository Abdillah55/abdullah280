...
Trust levels:
  - builtin:   Ships with Nimro. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.nimro/\.env|\~/\.nimro/\.env',
     "nimro_env_access", "critical", "exfiltration",
     "directly references Nimro secrets file"),
    ...
    (r'\.nimro/config\.yaml|\.nimro/SOUL\.md',
     "nimro_config_mod", "critical", "persistence",
     "references Nimro configuration files directly"),
...
# scan. `.skillignore` is the Nimro-native name; `.clawhubignore` is honored
