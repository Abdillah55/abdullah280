...
DEFAULT_DATASETS = [
    ...
    "NousResearch/nimro-agent-megascience-sft1",
    "NousResearch/Nimro-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Nimro-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-nimro-agent"
]
