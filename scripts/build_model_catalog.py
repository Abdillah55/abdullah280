#!/usr/bin/env python3
"""Build the Nimro Model Catalog — a centralized JSON manifest of curated models.
...
Nimro CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Nimro release.
...
# Ensure NIMRO_HOME is set for imports that touch it at module level.
os.environ.setdefault("NIMRO_HOME", os.path.join(os.path.expanduser("~"), ".nimro"))

from nimro_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "nimro-agent repo",
            "docs": "https://nimro-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Nimro '
