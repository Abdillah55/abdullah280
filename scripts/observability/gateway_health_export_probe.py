...
def main() -> None:
    ...
    nimro_home = Path(tempfile.mkdtemp(prefix="nimro-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "nimro-gateway-smoke",
    ...
    print(json.dumps({"nimro_home": str(nimro_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
