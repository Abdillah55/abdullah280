#!/usr/bin/env python3
"""Build the Nimro Skills Index — a centralized JSON catalog of all skills.
...
`nimro skills search/install` can use it without hitting the GitHub API.
...
# Ensure NIMRO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Nimro Skills Index...", flush=True)
