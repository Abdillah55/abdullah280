#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Nimro logs.
...
With no LOGFILE, reads ``$NIMRO_HOME/logs/agent.log`` (default ~/.nimro).
...
def default_log() -> Path:
    home = os.environ.get("NIMRO_HOME") or str(Path.home() / ".nimro")
