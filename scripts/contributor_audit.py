...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Nimro\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (nimro-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "nimro@nousresearch.com",
    "nimro-audit@example.com",
    "nousbot@nousresearch.com",
    "nimro@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
