...
def _profile_user_agent() -> str:
    """Return a ``nimro-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from nimro_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"nimro-cli/{_ver}"
    except Exception:
        return "nimro-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # nimro-cli UA so the catalog endpoint is reachable.
