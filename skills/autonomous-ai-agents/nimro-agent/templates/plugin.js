/**
 * Nimro desktop plugin template. Save as:
 *   <nimro home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <nimro home> is ~/.nimro by default, or ~/.nimro/profiles/<name>
 * when running a named profile (`nimro -p <name>`). Run `nimro doctor` (or
 ...
 * Only these imports resolve: @nimro/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@nimro/plugin-sdk'
