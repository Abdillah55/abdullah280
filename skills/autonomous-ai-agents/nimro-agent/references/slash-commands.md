...
Registry of record: `nimro_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Nimro config+state snapshots (CLI)
