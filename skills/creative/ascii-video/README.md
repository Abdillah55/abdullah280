...
Built for [Nimro Agent](https://github.com/NousResearch/nimro-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/nimro-agent/skills/creative/ascii-video`](https://github.com/NousResearch/nimro-agent/tree/main/skills/creative/ascii-video) via PR.
